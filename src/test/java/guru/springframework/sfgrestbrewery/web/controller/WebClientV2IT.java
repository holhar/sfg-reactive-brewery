...
class WebClientV2IT {
    ...
    void getBeerByUpc() throws InterruptedException {
        ...
        beerDtoMono.subscribe(beer -> {
            assertThat(beer).isNotNull();
            assertThat(beer.getBeerName()).isEqualTo("Galaxy Cat");
    ...
    void getBeerByUpcNotFound() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri(BeerRouterConfig.BEER_V2_URL_UPC + "/FOOBAR")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);

        beerDtoMono.subscribe(beer -> {}, throwable -> countDownLatch.countDown());
